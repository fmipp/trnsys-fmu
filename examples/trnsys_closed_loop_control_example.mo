...
equation
  ...
  connect(booleanToReal.y, tRNSYS_Room_Plant_fmu.control_signal) annotation (
      Line(points={{71,0},{80,0},{80,-40},{-80,-40},{-80,20},{-70.4,20}}, color=
         {0,0,127}));
  connect(tRNSYS_Room_Plant_fmu.room_temperature, add.u1) annotation (Line(
        points={{-48,25},{-40,25},{-40,6},{-32,6}}, color={0,0,127}));
  annotation (
